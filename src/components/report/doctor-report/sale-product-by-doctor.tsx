...
const SaleProductByDoctor = () => {
    ...
    const COLUMN_DEF: GridColDef[] = [
        ...
        },
        {
            ...
            maxWidth:150,
            field: 'payments',
            headerName: 'Tiền Tiền Trả'
        }

    ]
    return(
        <InitReport GridCol={COLUMN_DEF} title="Báo Cáo Bác Sĩ/Hàng Bán Theo Bác Sĩ" QueryString={GET_RES_EXAM} QueryProp="getResExam" IsAdvancedSearch={true}/>
    )
}

export default SaleProductByDoctor
