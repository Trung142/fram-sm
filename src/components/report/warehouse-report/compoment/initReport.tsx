...
const InitReport = (props: Props) => {
  ...
  const warehouselist=useMemo(()=>warehousedata?.getWarehouse?.items ?? [],[warehousedata])
      ...
      <Grid item md={12} xs={12}>
        <Card>
          <CardHeader
            ...
            action={
              <>
                <Button variant='contained' color='primary' sx={{ pl: 5, pr: 8 }}>
                ...
                {IsAdvancedSearch ? (
                  ...
                  <Grid item xs={3}>
                      <Autocomplete
                                ...
                                value={warehouselist.find((x: any) => x?.id === searchData.warehouseId) || null}
                                onChange={(e, value: any) => {
                                    handleChangeSearch('warehouseId',value?.id)
                                }}
                    ...
                    <Grid item xs={3}>
                        <Autocomplete
                                  ...
                                  renderInput={params => <TextField {...params} label='Hạn Dùng' />}
                          />
                      </Grid>      
                    <Grid item xs={4}>
                      <TextField
