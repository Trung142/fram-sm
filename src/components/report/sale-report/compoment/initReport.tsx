...
const InitReport = (props: Props) => {
  ...
  const {data:objectSearch}=useQuery(GET_EXPLORE_OBJECT)
  const objectSearchData=useMemo(()=>objectSearch?.getExploreObject?.items ?? [],[objectSearch])
  const statusList=[
    {
        id:100,
        label:'Chờ Khám'
