...
const RevenueByGroupService = () => {
    ...
    return(
        <InitReport GridCol={COLUMN_DEF} title="Báo Cáo Bán Hàng/Doanh Thu Theo Nhóm Dịch Vụ" QueryString={GET_RES_EXAM} QueryProp="getResExam" IsAdvancedSearch={false}/>
    )
}

export default RevenueByGroupService