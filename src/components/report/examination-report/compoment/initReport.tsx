...
import {excelButonstyle,printButtonstyle} from '../../utils/styles'
...
const InitReport = (props: Props) => {
  ...
  console.log(exploreObjectdataList)
              ...
              <>
                {IsAdvancedSearch ? (
                  <Grid>
                    ...
                    <Button variant='contained' color='primary' sx={printButtonstyle} style={{ marginLeft: 10 }}>
            ...
            <Grid container spacing={6}>
              ...
              <Grid item xs={8} md={8}>
                <Grid container gap={2} >   
                  ...
                  {IsAdvancedSearch && (
                    <Grid display={'flex'}>
                      <Typography alignContent={'center'} fontSize={18} marginLeft={2}>
                        {' '}
                        Tìm Kiếm Nâng Cao{' '}
                      </Typography>
                      <IconButton onClick={handleOpenAS}>
                        <Icon
                          icon={
