...
const DrugTB = () => {
    ...
    return(
        <InitReport GridCol={COLUMN_DEF} title="Báo Cáo Nhà Thuốc/Sổ Theo Dõi Xuất Nhập Thuốc" QueryString={GET_RES_EXAM} QueryProp="getResExam" IsAdvancedSearch={true}/>
    )
}
export default DrugTB
