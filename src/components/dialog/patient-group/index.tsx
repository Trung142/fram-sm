...
mutation Add($input: PatGroupInput!) {
  addPatGroup(data: $input) {
    id
    name
  }
}`;
...
mutation Update($input: PatGroupInput!) {
  updatePatGroup(data: $input) {
    id
    name
  }
}`;
          ...
          <FormControl fullWidth>
            ...
            {errors.name && (
              <FormHelperText sx={{ color: 'error.main' }} id='validation-basic-first-name'>
                Tên nhóm khách hàng không được để trống
              </FormHelperText>
            )}
          </FormControl>
...
PatientGroupDialog.defaultProps = {
  type: 'add',
}

export default PatientGroupDialog;
