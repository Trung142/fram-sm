...
mutation Update($input: JobInput!) {
  updateJob(data: $input) {
    id
    name
  }
}`;
          ...
          <FormControl fullWidth>
            ...
            {errors.name && (
              <FormHelperText sx={{ color: 'error.main' }} id='validation-basic-first-name'>
                Tên nghề nghiệp không được để trống
              </FormHelperText>
            )}
          </FormControl>
