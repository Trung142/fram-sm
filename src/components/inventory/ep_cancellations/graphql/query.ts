...
query GeWhExpCancel($input:WhExpCancelFilterInput, $skip: Int,$take: Int){
  getWhExpCancel(
    where: $input
    skip: $skip
    take: $take
...
export const GET_WH_CANCEL_DT = gql `
query GeWhExpCancelDt($input:WhExpCancelDtFilterInput, $skip: Int,$take: Int){
  getWhExpCancelDt(
    where: $input
    skip: $skip
    take: $take
