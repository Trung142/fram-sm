    ...
    register({
      variables: {
        input: {
          ...
          userVneid: e.target[7].value,
          userCccd: e.target[8].value
        }
      },
      onError: (error) => {
      ...
      >
        <Box sx={{ mx: 'auto', maxWidth: 400 }}>
          ...
          <form noValidate autoComplete='off' onSubmit={e => submit(e)}>
            <TextField autoFocus fullWidth sx={{ mb: 4 }} label='Username' placeholder='Nhập username' />


            <FormControl fullWidth sx={{ mb: 4 }}>
              <InputLabel htmlFor='auth-login-v2-password'>Mật khẩu</InputLabel>
              <OutlinedInput
                label='Password'
            ...
            <TextField fullWidth label='Họ' sx={{ mb: 4 }} placeholder='Nhập họ' />
            <TextField fullWidth label='Tên' sx={{ mb: 4 }} placeholder='Nhập tên' />
            <TextField fullWidth label='Email' sx={{ mb: 4 }} placeholder='Nhập email' />
            <TextField fullWidth label='Địa chỉ' sx={{ mb: 4 }} placeholder='Nhập địa chỉ' />
            <TextField fullWidth label='Số điện thoại' sx={{ mb: 4 }} placeholder='Nhập số điện thoại' />
            <TextField fullWidth label='Mã Vneid' sx={{ mb: 4 }} placeholder='Nhập mã Vneid' />
            <TextField fullWidth label='CCCD/CMND' sx={{ mb: 4 }} placeholder='Nhập CCCD/CMND' />
