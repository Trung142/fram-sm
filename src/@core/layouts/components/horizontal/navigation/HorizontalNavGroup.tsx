                ...
                >
                  <ListItemIcon
                    sx={{
                      mr: 2,
                      color: 'common.white',
                      ...(icon === navSubItemIcon && { color: 'common.white' })
                  ...
                  <Typography {...(menuTextTruncate && { noWrap: true })} sx={{ ...{ color: 'common.white' } }}>
                    <Translations text={item.title} />
                  </Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center', color: menuOpen ? 'common.white' : 'common.white' }}>
                  {item.badgeContent ? (
                    <Chip
