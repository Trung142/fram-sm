...
const HorizontalLayout = (props: LayoutProps) => {
  ...
  const { skin, appBar, navHidden, appBarBlur, contentWidth, mode } = settings
      ...
      <MainContentWrapper className='layout-content-wrapper' sx={{ ...(contentHeightFixed && { maxHeight: '100vh' }) }}>
        ...
        >
          ...
          <Box
            ...
            sx={{
              width: '100%',
              backgroundColor: theme => hexToRGBA(mode === "light" ? theme.palette.common.white : theme.palette.background.paper, appBarBlur ? 0.95 : 1),
